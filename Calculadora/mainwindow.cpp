...
MainWindow::~MainWindow()
{
    ...
    {
        /*ggm::Calculadora objeto;
        objeto.setPrimeiroTermo(ui->lineEditPrimeiroTermo->text().toDouble());
        objeto.setSegundoTermo(ui->lineEditSegundoTermo->text().toDouble());*/
        ggm::Calculadora objeto(ui->lineEditPrimeiroTermo->text().toDouble(), ui->lineEditSegundoTermo->text().toDouble());
